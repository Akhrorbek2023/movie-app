...
export const MovieSingleCard = ({image, title, date, budget, runtime, overview,  genres, languages }) => {
  return (
    ...
    <img className='w-[370px]' src={image} alt="" />
     <div className='ml-[60px]'>
      ...
      <div className='flex py-1'>
          <h1 className='w-[140px] mr-[20px] bg-slate-800 px-2 py-2'>Budget</h1>
          <h1 className='bg-slate-800 w-[100%] px-2 py-2 hover:bg-slate-700'>{budget} mln $</h1>
      </div>
      <div className='flex py-1'>
      ...
      <p className='text-[22px]  mt-10 mb-4 text-red-700'>{overview}</p>

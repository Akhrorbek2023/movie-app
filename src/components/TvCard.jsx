...
export const TvCard = ({ id , image, title, date, vote}) => {
  return (
   <NavLink to={`/single-tv/${id}`} key={id}>
     <div className=' mb-8 hover:border border-white w-[280px] rounded-lg relative' key={id}>
